...
lastmod: '2026-07-29T10:02:23+00:00'
...
Ever since upgrading from OS X 10.9 to Yosemite (10.10) I’ve been getting a dialog popping up with the message "To view this web content, you need to install the Java Runtime Environment" periodically. As far as I know I have no software that needs Java to run.

When I asked on Twitter[^twitter], the most common suggestion was that it was the Adobe updater. But I don’t have PhotoShop or anything else likely installed.
...
*Update, July 2026*: _removed "error" tag that triggered Google's "soft 404" warning, removed a screenshot
that it no longer present, and updated the copy to describe what was shown in the screenshot._
 
[^twitter]: I no longer have a Twitter account, so I'm not linking to the post.
